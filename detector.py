...
def tier3d_repetitive_opener(texts, t2_total=0):
    """
...
def score_user(uid, posts, username="", verbose=False):
    """
    ...
    s, detail = tier3d_repetitive_opener(texts, t2_total=t2_total)
...
def detect_bots(dataset_path, threshold=DETECTION_THRESHOLD, verbose=False):
    ...
    for uid, posts in user_posts.items():
        ...
        score, breakdown = score_user(uid, posts, username=username, verbose=verbose)
